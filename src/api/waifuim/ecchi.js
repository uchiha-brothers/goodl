 ...
 * • Copyright © 2025 by JerryCoder. ll rights reserved.
 */
...
module.exports = function (app) {
    ...
    async function fetchHentaiImage() {
        try {
            const response = await axios.get(
                'https://jerryproxy.vercel.app/api/proxy?url=https://api.nekorinn.my.id/waifuim/ecchi',
    ...
    app.get('/waifuim/ecchi', async (req, res) => {
        try {
